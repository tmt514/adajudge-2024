...
const parser = new Parser({
  description: 'Copy submissions of problem id y in homework id x (exclude admin & TA) before deadline to /home/ada2018/adajudge/moss/x_y/'
});
...
(async () => {
  ...
  const folder = `/home/ada2018/adajudge/moss/${args.homework_id}_${args.problem_id}`;
